...
declare namespace Cloudflare {
	interface Env {
		...
		SUI_SIGNER_MNEMONIC: "pull skull artist draw mystery rule busy peasant skate crop crack pride";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUI_NETWORK" | "SUI_PACKAGE_ID" | "NBTC_OBJECT_ID" | "LIGHT_CLIENT_OBJECT_ID" | "SUI_SIGNER_MNEMONIC" | "BITCOIN_NETWORK" | "NBTC_DEPOSIT_ADDRESS" | "SUI_FALLBACK_ADDRESS">> {}
}
